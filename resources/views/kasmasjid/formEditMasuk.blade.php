...
<div class="modal fade" id="editMasuk{{ $d->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action={{url('kas-masjid-pemasukan/edit/' . $d->id)}} method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        <div class="modal-body">
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ $d->masuk }}" id="formGroupExampleInput2" placeholder="Another input placeholder" name="masuk">
              </div>
              <div class="mb-3">
